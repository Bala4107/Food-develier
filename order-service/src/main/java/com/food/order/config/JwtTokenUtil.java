...
public class JwtTokenUtil implements Serializable {
    ...
    // Read JWT secret from environment variable JWT_SECRET (set on Render)
    // Falls back to a default for local development
    @Value("${app.jwt.secret:9a4f2c8d3e7b1a6c5d8e7f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c}")
